      ...
      <div className="max-w-3xl mx-auto px-3 md:px-4 py-5 md:py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-xl p-4 md:p-6 space-y-5 md:space-y-6 text-sm text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <p>CartoFM is a free radio aggregation platform that provides access to publicly available internet radio streams from around the world. We do not host or produce any radio content.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">3. Content Disclaimer</h2>
            <p>All radio streams are provided by third-party broadcasters. CartoFM is not responsible for the content, availability, or quality of any radio stream. Content may vary and is subject to the policies of the respective broadcasters.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">4. User Conduct</h2>
            <p>You agree to use the service for lawful purposes only. You may not attempt to disrupt, overload, or interfere with the operation of CartoFM or any connected services.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">5. Intellectual Property</h2>
            <p>The CartoFM name, logo, and user interface design are the property of CartoFM. Radio station names, logos, and stream content belong to their respective owners.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">6. Limitation of Liability</h2>
            <p>CartoFM is provided "as is" without warranties of any kind. We shall not be liable for any damages arising from the use or inability to use the service.</p>
          </div>
          <div>
