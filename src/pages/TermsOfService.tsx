      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-xl p-6 space-y-6 text-sm text-muted-foreground leading-relaxed">
          <div>
            ...
            <p>By accessing and using CartoFMbe bound by these Terms of Service. If you do not agree, please discontinue use of the service.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">2. Description of Service</h2>
            <p>RadCarCarCarCarCartoFMn platform that provides access to publicly available internet radio streams from around the world. We do not host or produce any radio content.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">3. Content Disclaimer</h2>
            <p>All radio streams are provided by third-party broadcasters. RadioVCartoFCartoFCartoFCartoFMnt, availability, or quality of any radio stream. Content may vary and is subject to the policies of the respective broadcasters.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">4. User Conduct</h2>
            <p>You agree to use the service for lawful purposes only. You may not attempt to disrupt, overload, or interfere with the operation of RadioVersCartoFMonCartoFMviCartoFM         </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">5. Intellectual Property</h2>
            <p>The RadioVerse nCartoFM nameCartoFM name, logo, and user interface design are the property of CartoFMand stream content belong to their respective owners.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground mb-2">6. Limitation of Liability</h2>
            <p>RadioVerse is provCartoFMs" without warranties of any kind. We shall not be liable for any damages arising from the use or inability to use the service.</p>
          </div>
          <div>
