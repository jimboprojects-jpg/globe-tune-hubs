...
import { E as ExternalLink, P as ArrowLeft, f as Play, l as Search, m as Music, u as Radio, v as MapPin, w as Globe, y as LoaderCircle } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/CountryPage-BbqOLNBU.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var searchStations = (stations, query) => {
	const q = query.toLowerCase();
	return stations.filter((s) => s.name.toLowerCase().includes(q) || s.country.toLowerCase().includes(q) || s.city.toLowerCase().includes(q) || s.genre.toLowerCase().includes(q));
};
var countryContent = {
	US: {
...
*/
var getCountryContent = (countryCode, countryName, stationCount) => {
...
var CountryFlag = ({ code, size = "w-8 h-6" }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
...
var CountryListPage = () => {
	...
	const countries = (0, import_react.useMemo)(() => {
		...
		for (const s of stations) {
			...
			else map.set(s.countryCode, {
				name: s.country,
				code: s.countryCode,
				count: 1
			});
		}
		return Array.from(map.values()).filter((c) => !searchQuery || c.name.toLowerCase().includes(searchQuery.toLowerCase())).sort((a, b) => a.name.localeCompare(b.name));
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Globe, { className: "w-5 h-5 text-primary" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
							className: "text-lg font-bold",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-gradient-primary",
									children: t("country.listenBy")
								}),
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-gradient-accent",
									children: t("country.country")
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-muted-foreground ml-auto",
							children: t("country.countries", { count: countries.length })
						})
					]
				})
			}),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: t("country.browseIntro")
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					isLoadingStations ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: countries.map((country, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.button, {
							initial: {
								opacity: 0,
								y: 10
							},
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: t("country.stations", { count: country.count })
									})]
								}),
...
var CountryDetailPage = () => {
	const { countryCode } = useParams$1();
	const navigate = useNavigate$1();
	const [searchQuery, setSearchQuery] = (0, import_react.useState)("");
	const { t } = useTranslation();
	const { stations, isLoadingStations, currentStation, isPlaying, isLoading: playerLoading, volume, error, play, pause, setVolume, stop, bands, activePreset, updateBands, applyPreset, isFavorite, toggleFavorite } = useGlobalPlayer();
	const countryStations = (0, import_react.useMemo)(() => {
		const filtered = stations.filter((s) => s.countryCode?.toUpperCase() === countryCode?.toUpperCase());
	...
	const content = (0, import_react.useMemo)(() => getCountryContent(countryCode || "", countryName, countryStations.length), [
		countryCode,
		countryName,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							className: "text-xs text-muted-foreground",
							children: t("country.stations", { count: countryStations.length })
						})] })
					]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radio, { className: "w-4 h-4 text-primary" }), t("country.radioLandscape")]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm text-muted-foreground leading-relaxed",
								children: content.landscape
							}),
							content.funFact && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					isLoadingStations ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex items-center justify-center py-20",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-8 h-8 animate-spin text-primary" })
					}) : countryStations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "text-center py-20 text-muted-foreground",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radio, { className: "w-12 h-12 mx-auto mb-3 opacity-40" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: t("country.noStations") })]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollArea, {
						className: "h-[calc(100dvh-380px)] md:h-[calc(100dvh-420px)]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "space-y-1",
							children: countryStations.map((station) => {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "w-2.5 h-2.5" }), station.city]
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														className: "flex items-center gap-0.5 truncate capitalize",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Music, { className: "w-2.5 h-2.5" }), station.genre]
													})]
												})]
											}),
...
var CountryPage = () => {
	const { countryCode } = useParams$1();
	if (countryCode) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryDetailPage, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryListPage, {});
};
//#endregion
export { CountryPage as t };
