//#region node_modules/.nitro/vite/services/ssr/assets/genreContent-DMBRiqiW.js
var GENRES = [
	{
		slug: "pop",
		name: "Pop",
...
var matchStationToGenre = (stationGenre, genreSlug) => {
	const patterns = GENRE_MATCH_MAP[genreSlug];
	if (!patterns) return false;
	const lower = stationGenre.toLowerCase();
	return patterns.some((p) => lower.includes(p));
};
var getGenreBySlug = (slug) => GENRES.find((g) => g.slug === slug);
var getGenreListSEO = () => ({
...
//#endregion
export { matchStationToGenre as i, getGenreBySlug as n, getGenreListSEO as r, GENRES as t };
