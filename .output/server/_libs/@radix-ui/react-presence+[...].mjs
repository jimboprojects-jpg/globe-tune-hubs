...
import { n as useLayoutEffect2$1 } from "./react-portal+[...].mjs";
//#region node_modules/@radix-ui/react-presence/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
...
__name(useStateMachine$1, "useStateMachine");
var Presence$1 = /* @__PURE__ */ __name((props) => {
...
function usePresence$1(present) {
	...
	import_react.useEffect(() => {
		if (state === "mounted") {
			prevAnimationNameRef.current = mountAnimationNameRef.current ?? getAnimationName$1(stylesRef.current);
	...
	return {
		...
		ref: import_react.useCallback((node2) => {
			if (node2) {
				...
				mountAnimationNameRef.current = getAnimationName$1(styles);
			} else stylesRef.current = null;
			setNode(node2);
		}, [])
	};
}
__name(usePresence$1, "usePresence");
...
__name(getAnimationName$1, "getAnimationName");
...
__name(getElementRef$1, "getElementRef");
//#endregion
...
//#endregion
export { Presence$1 as n, Presence as t };
